    ...
    return (
      <div className="flex gap-4 shadow-xl rounded-lg overflow-hidden border border-gray-200 h-[420px] mt-5">
        ...
        <div className="w-1/2 p-2 flex mt-4 flex-col justify-between h-full">
          ...
          <div className="text-sm grid grid-cols-1 mb-6">
            <p>
          ...
          >
            ...
            <button className="bg-red-500 text-white px-4 py-2 rounded shadow hover:bg-red-600 font-medium text-xs w-1/3 flex items-center justify-center gap-2">
